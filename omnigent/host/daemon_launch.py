...
# These waits usually resolve fast — a warm host answers "online" on the
# first probe, a fresh runner connects in a second or two — but they gate
# every native-harness launch. A flat cadence spends up to a full
# interval doing nothing after the thing is already ready, so probe
# tightly at first and ease off to the steady cadence for the long tail.
